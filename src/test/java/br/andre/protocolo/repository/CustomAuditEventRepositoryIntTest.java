package br.andre.protocolo.repository;

import br.andre.protocolo.ProtocoloApp;
import br.andre.protocolo.config.Constants;
import br.andre.protocolo.config.audit.AuditEventConverter;
import br.andre.protocolo.domain.PersistentAuditEvent;
...
import static br.andre.protocolo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
